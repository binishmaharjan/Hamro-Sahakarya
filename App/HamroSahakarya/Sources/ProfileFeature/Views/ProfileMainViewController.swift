...
public final class ProfileMainViewController: NibLessNavigationController {
    ...
    private func setup() {
        title = nil
        tabBarItem.image = Asset.iconProfile.image.withRenderingMode(.alwaysOriginal)
        tabBarItem.selectedImage = Asset.iconProfileH.image.withRenderingMode(.alwaysOriginal)
