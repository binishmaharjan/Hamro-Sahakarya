...
extension HomeViewController {
    ...
    private func setupAccountDetailView() {
        accountDetailView = homeContentViewFactory.makeAccountDetailView(
            allMembers: viewModel.allMembers.asObservable(),
...
// MARK: AssociatedHomeView
extension HomeViewController: AssociatedHomeView {
    public func getAssociateView() -> HomeView {
        return .home
    }
}
