...
public final class FirebaseLogRemoteApi: LogRemoteApi {
    public init() {}
    ...
    public func fetchLogsFromLastSnapshot() -> Promise<[GroupLog]> {
    ...
    public func addJoinedLog(userSession: UserSession) -> Promise<UserSession> {
    ...
    public func addMonthlyFeeLog(admin: UserProfile, userProfile: UserProfile, amount: Int) -> Promise<Void> {
    ...
    public func addExtraOrExpensesLog(type: ExtraOrExpenses, admin: UserProfile, amount: Int, reason: String) -> Promise<Void> {
        return Promise<Void> { seal in
    ...
    public func addAmountOrDeductAmountLog(type: AddOrDeduct ,admin: UserProfile, member: UserProfile, amount: Int) -> Promise<Void> {
        return Promise<Void> { seal in
    ...
    public func addLoanMemberLog(admin: UserProfile, member: UserProfile, amount: Int) -> Promise<Void> {
        return Promise<Void> { seal in
            let logCreator = admin.username
            let logTarget = member.username
            let amount = amount
    ...
    public func addLoanReturnedLog(admin: UserProfile, member: UserProfile, amount: Int) -> Promise<Void> {
        return Promise<Void> { seal in
            let logCreator = admin.username
            let logTarget = member.username
            let amount = amount
    ...
    public func addRemoveMemberLog(admin: UserProfile, member: UserProfile) -> Promise<Void> {
        return Promise<Void> { seal in
            let logCreator = admin.username
            let logTarget = member.username
